...
export const PARTIES: Record<PartyId, Party> = {
  PMLN: {
    ...
    provinceStrength: { Punjab: 1.25, Sindh: 0.15, KP: 0.25, Balochistan: 0.2, Islamabad: 0.9 },
    playable: true,
  ...
  PTI: {
    ...
    provinceStrength: { Punjab: 1.0, Sindh: 0.35, KP: 1.3, Balochistan: 0.3, Islamabad: 1.05 },
